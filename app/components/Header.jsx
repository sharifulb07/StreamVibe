...
export default function Header() {
    ...
    return (
        <header className="flex justify-between items-center px-[8%] py-[30px]">
...
{isMobileOpen && (
        <div ref={menuRef} className="absolute top-20 right-10 z-500 flex flex-col p-5 rounded-xl bg-orange-100 md:hidden lg:hidden">
          <ul
